defmodule EshopWeb.ItemWarehouseVariantView do
  ...
  def render("index.json", %{item_warehouse_variants: item_warehouse_variants}) do
    %{data: render_many(item_warehouse_variants, ItemWarehouseVariantView, "item_warehouse_variant.json")}
  end

  def render("show.json", %{item_warehouse_variant: item_warehouse_variant}) do
    %{data: render_one(item_warehouse_variant, ItemWarehouseVariantView, "item_warehouse_variant.json")}
  end
