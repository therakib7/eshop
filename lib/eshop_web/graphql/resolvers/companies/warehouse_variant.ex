defmodule EshopWeb.Schema.Resolvers.WarehouseVariant do
    ...
    def update_warehouse_variant(%{id: id, warehouse_variant_params: warehouse_variant_params}, _info) do
		case {:ok, Eshop.Companies.get_warehouse_variant!(id)} do
			{:ok, warehouse_variant} -> warehouse_variant |> Eshop.Companies.update_warehouse_variant(warehouse_variant_params) 
		end  
	end
