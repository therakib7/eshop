defmodule EshopWeb.Schema.Resolvers.WarehouseVariantValue do
  ...
  def update_warehouse_variant_value(
        %{id: id, warehouse_variant_value_params: warehouse_variant_value_params},
        _info
      ) do
    case {:ok, Eshop.Companies.get_warehouse_variant_value!(id)} do
      {:ok, warehouse_variant_value} ->
        warehouse_variant_value
        |> Eshop.Companies.update_warehouse_variant_value(warehouse_variant_value_params)
    end
  end
  ...
  def delete_warehouse_variant_value(%{id: id}, _info) do
    case {:ok, Eshop.Companies.get_warehouse_variant_value!(id)} do
      {:ok, warehouse_variant_value} ->
        warehouse_variant_value |> Eshop.Companies.delete_warehouse_variant_value()
    end
  end
end
