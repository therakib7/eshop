defmodule EshopWeb.Schema.Resolvers.ShopPaymentMethod do
    ...
    def update_shop_payment_method(%{id: id, shop_payment_method_params: shop_payment_method_params}, _info) do
		case {:ok, Eshop.Payments.get_shop_payment_method!(id)} do
			{:ok, shop_payment_method} -> shop_payment_method |> Eshop.Payments.update_shop_payment_method(shop_payment_method_params) 
		end  
	end

	def delete_shop_payment_method(%{id: id}, _info) do 
		case {:ok, Eshop.Payments.get_shop_payment_method!(id)} do
			{:ok, shop_payment_method} -> shop_payment_method |> Eshop.Payments.delete_shop_payment_method() 
		end 
	end  
end