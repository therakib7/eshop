defmodule EshopWeb.Schema.Resolvers.ShopShippingMethod do
    ...
    def update_shop_shipping_method(%{id: id, shop_shipping_method_params: shop_shipping_method_params}, _info) do
		case {:ok, Eshop.Shipments.get_shop_shipping_method!(id)} do
			{:ok, shop_shipping_method} -> shop_shipping_method |> Eshop.Shipments.update_shop_shipping_method(shop_shipping_method_params) 
		end  
	end

	def delete_shop_shipping_method(%{id: id}, _info) do 
		case {:ok, Eshop.Shipments.get_shop_shipping_method!(id)} do
			{:ok, shop_shipping_method} -> shop_shipping_method |> Eshop.Shipments.delete_shop_shipping_method() 
		end 
	end  
end